        ...
        <section className="py-20 lg:py-28 bg-surface">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <SectionHeading
              ...
              description="Practical guidance on care, benefits, and aging-in-place from our team."
            />
            ...
            <div className="text-center mt-12">
              <Link
                href="/blog"
                className="inline-flex items-center gap-2 px-7 py-3.5 bg-primary hover:bg-primary-dark text-white font-semibold rounded-lg transition-all shadow-md hover:-translate-y-0.5"
              >
